                ...
                <div class="row">
                    <div class="col-md-12 xs-text-center">
                        <ol class="breadcrumb mt-10 white">
                            <li><a href="#">Home</a></li>
                            <li class="active text-theme-colored"><?php echo $title['title']; ?></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="mb-15 bg-bordered">
                        ...
                        <ul class="subMenuLink p-10">
                            <?php foreach($left_menus as $left_menu):  ?>
                              <?php if(isset($domestic)) {?>
                                <li><a href="<?php echo base_url(); ?>doctor/domestic_expert/<?php $x = strtolower($left_menu->url); $y = str_replace(' ', '_', $x); echo $y; ?>"><?php echo $left_menu->title; ?></a></li>
                                <?php } else { ?>
                                    <li><a href="<?php echo base_url(); ?>doctor/international_expert/<?php $x = strtolower($left_menu->url); $y = str_replace(' ', '_', $x); echo $y; ?>"><?php echo $left_menu->title; ?></a></li>
                            <?php } endforeach; ?>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <img style="border:2px solid #0293A6;height:120px;width:230px;" src="<?=base_url()?>uploads/front/doctor/<?php echo $l->img; ?>" alt='<?php echo $l->img; ?>' align="middle">
                        <br>
                        <p style="color:#0293A6;"><?php echo $l->title; ?>, <b><?php echo $l->country; ?></b></p>
                    </div>
                  <?php endforeach; ?>
                </div>
                <div class="col-md-3">
