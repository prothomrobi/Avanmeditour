                ...
                <div class="row"> 
                    <div class="col-md-12 xs-text-center">
                        <ol class="breadcrumb mt-10 white">
                            <li><a href="#">Home</a></li>
                            <li class="active text-theme-colored">Article</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div class="container pb-0">
            <div class="row">
                        ...
                        <article class="post clearfix mb-50">
                            <div class="col-sm-5">
                                <div class="entry-header">
                                    <div class="post-thumb"> <img class="img-responsive img-fullwidth" src="<?=base_url()?>uploads/front/article/<?php echo $list->img; ?>" alt=""> </div>
                                </div>
                            </div>
                            <div class="col-sm-7">
                ...
                <div class="col-md-3">
                    <div class="mb-15">
                        <h4 class="p-10 bg-info m-0">RECENT ARTICLE</h4>
                        <?php foreach($recents as $recent):  ?>
                        <div class="events">
                            <img src="<?=base_url()?>uploads/front/article/<?php echo $recent->img; ?>">
