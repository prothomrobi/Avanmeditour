                ...
                <div class="row">
                    <div class="col-md-12 xs-text-center">
                        <ol class="breadcrumb mt-10 white">
                            <li><a href="#">Home</a></li>
                            <li class="active text-theme-colored"><?php echo $list['0']->country; ?></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="mb-15 bg-bordered">
                        ...
                        <ul class="subMenuLink p-10">
                            <?php foreach($left_menus as $left_menu):  ?>
                                <li><a href="<?php echo base_url(); ?>hospital/country/<?php $x = strtolower($left_menu->country); $y = str_replace(' ', '_', $x); echo $y; ?>"><?php echo $left_menu->country; ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-6" style="margin-bottom:30px;">
                        <img style="border:2px solid #0293A6;height:100px;width:230px;" src="<?=base_url()?>assets/front/images/clients/<?php echo $l->img; ?>" alt='<?php echo $l->img; ?>' align="middle">
                        <strong><i style="width:230px; color:#0293A6; margin-left:50px;"><?php echo $l->title; ?></i></strong>
                    </div>
                  <?php endforeach; ?>
                </div>
                <div class="col-md-3">
