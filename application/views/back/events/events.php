            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Add Events form</h3>
                    </div><!-- /.box-header -->
                    ...
                    <?php } ?>
                    <!-- form -->
                    <?php echo form_open_multipart(site_url("admin_panel/events"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            <!-- news tilte -->
                            <div class="form-group">
                                <label for="inputphn" class="col-sm-2 control-label">Events Title <sup>*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" value="" placeholder="Events title" name="title" maxlength="256" required>
                                </div>
                            </div>
                            <!-- news description -->
                            <div class="form-group">
                                <label for="inputphn" class="col-sm-2 control-label">Events Description <sup>*</sup></label>
                                <div class="col-sm-8">
                            ...
                            <!-- image -->
                            <div class="form-group">
                                <label for="Inputprod_img" class="col-sm-2 control-label">Events Image <sup>*</sup></label>
                                <div class="col-sm-8">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button type="submit" class="btn btn-primary">Post Events</button>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <?php if(empty($lists)) : ?>
                        <div class="box-header">
                            <h3 class="box-title">No Events Found!</h3>
                        </div>
                    <?php else: ?>
                    <div class="box-header">
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url(); ?>uploads/front/events/thumb/<?php echo $list->img; ?>" alt="<?php echo $list->img; ?>" >
                                    </td>
                                    <td>
                                ...
                                <div class="modal fade" id="update<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/update_events")); ?>
                                                <div class="modal-body">
                                                    <!-- title -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="inputbr_name"> Events Title<sup>*</sup></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="inputbr_name"> Events Description<sup>*</sup></label>
                                ...
                                <div class="modal fade" id="replace<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open_multipart(site_url("admin_panel/replace_image_events")); ?>
                                                <div class="modal-body">
                                                    <!-- replace image -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                ...
                                <div class="modal fade" id="delete<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/delete_events")); ?>
                                                <div class="modal-footer">
                                                    <input name="id" type="hidden" value="<?php echo $list->id; ?>" required/>
                                                    <input name="img" type="hidden" value="<?php echo $list->img; ?>" required/>
