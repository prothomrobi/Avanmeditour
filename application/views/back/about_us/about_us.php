            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Add about us form</h3>
                    </div><!-- /.box-header -->
                    ...
                    <?php } ?>
                    <!-- form -->
                    <?php echo form_open_multipart(site_url("admin_panel/about_us"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            <!-- title -->
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button type="submit" value="submit" class="btn btn-primary">Add About us</button>
                                ...
                                <div class="modal fade" id="update<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/update_about_us")); ?>
                                ...
                                <div class="modal fade" id="delete<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/delete_about_us")); ?>
                                                <div class="modal-footer">
                                                    <input name="id" type="hidden" value="<?php echo $list->id; ?>" required/>
