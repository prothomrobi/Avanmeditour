        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <?php } ?>
                    <!-- form -->
                    <?php echo form_open_multipart(site_url("admin_panel/news"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            <!-- news tilte -->
                            <div class="form-group">
                                <label for="inputphn" class="col-sm-2 control-label">News Title <sup>*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" value="" placeholder="News title" name="title" maxlength="256" required>
                                </div>
                            </div>
                            <!-- news description -->
                            <div class="form-group">
                                <label for="inputphn" class="col-sm-2 control-label">News Description <sup>*</sup></label>
                                <div class="col-sm-8">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <?php if(empty($lists)) : ?>
                        <div class="box-header">
                            <h3 class="box-title">No News Found!</h3>
                        </div>
                    <?php else: ?>
                    <div class="box-header">
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url(); ?>uploads/front/news/thumb/<?php echo $list->img; ?>" alt="<?php echo $list->img; ?>" >
                                    </td>
                                    <td>
                                ...
                                <div class="modal fade" id="update<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/update_news")); ?>
                                                <div class="modal-body">
                                                    <!-- title -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="inputbr_name"> News Title<sup>*</sup></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="inputbr_name"> News Description<sup>*</sup></label>
                                ...
                                <div class="modal fade" id="replace<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open_multipart(site_url("admin_panel/replace_image_news")); ?>
                                                <div class="modal-body">
                                                    <!-- replace image -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                ...
                                <div class="modal fade" id="delete<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/delete_news")); ?>
                                                <div class="modal-footer">
                                                    <input name="id" type="hidden" value="<?php echo $list->id; ?>" required/>
                                                    <input name="img" type="hidden" value="<?php echo $list->img; ?>" required/>
