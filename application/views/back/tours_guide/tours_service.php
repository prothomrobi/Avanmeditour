<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Tours Service</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Admin Panel</a></li>
            <li class="active">Add Tours Service</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Add tours service form</h3>
                    </div><!-- /.box-header -->
                    ...
                    <?php } ?>
                    <!-- form -->
                    <?php echo form_open_multipart(site_url("admin_panel/add_tours_service"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            <!--  country name -->
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button type="submit" class="btn btn-primary">Add Tours Service</button>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <?php if(empty($lists)) : ?>
                        <div class="box-header">
                            <h3 class="box-title">No Tours Service Found!</h3>
                        </div>
                    <?php else: ?>
                    <div class="box-header">
                        <h3 class="box-title">Tours Service List</h3>
                    </div>
                    <!-- box content -->
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url(); ?>uploads/front/tours_guide/tours_service/thumb/<?php echo $list->img; ?>" alt="<?php echo $list->img; ?>" >
                                    </td>
                                    <td>
                                ...
                                <div class="modal fade" id="update<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/update_tours_service")); ?>
                                ...
                                <div class="modal fade" id="replace<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open_multipart(site_url("admin_panel/replace_image_tours_service")); ?>
                                                <div class="modal-body">
                                                    <!-- replace image -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                ...
                                <div class="modal fade" id="delete<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open(site_url("admin_panel/delete_tours_service")); ?>
                                                <div class="modal-footer">
                                                    <input name="id" type="hidden" value="<?php echo $list->id; ?>" required/>
                                                    <input name="img" type="hidden" value="<?php echo $list->img; ?>" required/>
